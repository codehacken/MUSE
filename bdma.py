...
# main
parser = argparse.ArgumentParser(description='Bidirectional Manifold Alignment.')
...
# network
parser.add_argument("--n_layers", type=int, default=1, help="BDMA layers")
parser.add_argument("--n_hid_dim", type=int, default=2048, help="BDMA hidden layer dimensions")
...
# parser.add_argument("--n_most_frequent", type=int, default=75000, help="Select embeddings of the k most frequent words for discrimination (0 to disable)")
parser.add_argument("--n_smooth", type=float, default=0.1, help="BDMA smooth predictions")
parser.add_argument("--n_clip_weights", type=float, default=0, help="Clip discriminator weights (0 to disable)")
...
"""
Learning loop for BDMA Training
"""
# logger.info('----> BDMA TRAINING <----\n\n')
# Training loop
for n_epoch in range(params.n_epochs):

    logger.info('Starting bdma training epoch %i...' % n_epoch)
    tic = time.time()
    n_words_proc = 0
    stats = {'DIS_COSTS': []}
